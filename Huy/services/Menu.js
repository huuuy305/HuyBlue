const Menu = [
    {
        ...
        details: 'Tiến hành phân tích trang web và các yêu cầu ứng dụng.',
        price: 10000000,
        thumbImage: 'https://pngimg.com/uploads/php/php_PNG10.png',
        carouselImages: [
    ...
    },
    {
        ...
        sizes: ['XS', 'S', 'M', 'L', 'XL'],
        genre: 2,
        thumbImage: 'http://dotnetguru.org/wp-content/uploads/2018/12/front-end-vs-back-end.jpg',
        carouselImages: [
    ...
    },
    {
        ...
        sizes: ['XS', 'S', 'M', 'L', 'XL'],
        genre: 2,
        thumbImage: 'https://brandslogos.com/wp-content/uploads/images/large/java-logo-1.png',
        carouselImages: [
    ...
    },
    {
        ...
        sizes: ['M', 'L', 'XL'],
        genre: 1,
        thumbImage: 'https://logodownload.org/wp-content/uploads/2019/10/python-logo-0.png',
        carouselImages: [
    ...
    {
        id: 5,
        name: 'Chuyên Viên Quản Trị Hệ Thống',
        ...
        sizes: ['S', 'M', 'L', 'XL'],
        genre: 1,
        thumbImage: 'http://www.baltana.com/files/wallpapers-5/Programmer-HD-Desktop-Wallpaper-17575.jpg',
        carouselImages: [
    ...
    },
    {
        ...
        sizes: ['S-M', 'L-XL'],
        genre: 1,
        thumbImage: 'https://www.testpreptraining.com/blog/wp-content/uploads/2019/12/AWS-DevOps-Engineer-Professional.png',
        carouselImages: [
    ...
    },
    {
        ...
        genre: 3,
        thumbImage: 'https://izdesigner.net/wp-content/uploads/top-10-website-hoc-lap-trinh-web-mien-phi-tot-nhat-8.png',
        carouselImages: [
    ...
    },
    {
        ...
        genre: 3,
        thumbImage: 'https://laptrinhcuocsong.com/images/lap-trinh-vien.png',
        carouselImages: [
